...
class _FiltersPanelState extends State<FiltersPanel> {
  ...
  Widget _iconWidgetForTipoArea(String key) {
    ...
    switch (key) {
      case 'area_sosta':
        asset = 'assets/icons/icon_p.png';
        break;
      case 'campeggio':
        asset = 'assets/icons/icon_c.png';
        break;
      case 'agricampeggio':
        asset = 'assets/icons/icon_apn.png';
        break;
      default:
  ...
  Widget _iconWidgetForServizio(String key) {
    ...
    String? asset;
    if (lower.contains('elettric')) asset = 'assets/icons/service_electricite.png';
    if (lower.contains('acqua potabile') || lower.contains('potabile')) asset = 'assets/icons/service_point_eau.png';
    if (lower.contains('nere')) asset = 'assets/icons/service_eau_noire.png';
    if (lower.contains('grigie')) asset = 'assets/icons/service_eau_usee.png';
    if (lower.contains('bagni') || lower.contains('wc')) asset = 'assets/icons/service_wc_public.png';
    if (lower.contains('docce')) asset = 'assets/icons/service_douche.png';
    if (lower.contains('wi‑fi') || lower.contains('wifi')) asset = 'assets/icons/service_wifi.png';
    if (lower.contains('animali')) asset = 'assets/icons/service_animaux.png';
    if (lower.contains('lavanderia')) asset = 'assets/icons/service_laverie.png';
    if (lower.contains('gpl')) asset = 'assets/icons/service_gpl.png';
    if (lower.contains('lavaggio')) asset = 'assets/icons/service_lavage.png';
    if (lower.contains('cestini') || lower.contains('rifiuti')) asset = 'assets/icons/service_poubelle.png';
