      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            PositionedBackButton(spotId: spot.id),
          ],
        ),
      ),
...
class PositionedBackButton extends StatelessWidget {
  ...
  const PositionedBackButton({super.key, required this.spotId});

  @override
  Widget build(BuildContext context) {
    final favorites = context.watch<FavoritesProvider>();
    final isFav = favorites.isFavorite(spotId);

    return Container(
      padding: const EdgeInsets.fromLTRB(12, 8, 12, 12),
      // alignment: Alignment.centerLeft, // Rimosso per evitare che il Container copra tutto lo schermo
          ...
          children: [
            ...
            CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  favorites.toggleFavorite(spotId);
                },
              ),
            ),
          ],
...
class _SpotTypeBadge extends StatelessWidget {
  final String? type;

  const _SpotTypeBadge({this.type});
